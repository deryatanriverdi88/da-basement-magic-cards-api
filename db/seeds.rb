...
# # MagicCard.default_order.all.slice(26528, MagicCard.default_order.all.length).each do |c|
...
# MagicCard.default_order.all.slice(50000, MagicCard.default_order.all.length).each do |c|
